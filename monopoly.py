...
def simulate_monopoly_games(total_games: int):
    ...
    print(f"Monopoly simulator: 1 player, Trump mode We simulated 10000 games It took an average of {mean_of_throws} throws for the player to collect all streets")
    # print(throws_list)
